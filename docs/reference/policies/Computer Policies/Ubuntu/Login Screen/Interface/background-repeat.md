...
| Element      | Value                          |
| ---          | ---                            |
| Location     | <code>Computer Policies -> Ubuntu -> Login Screen -> Interface -> how the background image will be repeated.</code>     |
| Registry Key | <code>Software\Policies\Ubuntu\gdm\dconf\com\ubuntu\login-screen\background-repeat</code>          |

...
| Element      | Value                          |
| ---          | ---                            |
| Location     | <code>User Policies -> Ubuntu -> Desktop -> Screensaver -> Picture Options</code>     |
| Registry Key | <code>Software\Policies\Ubuntu\dconf\org\gnome\desktop\screensaver\picture-options</code>          |

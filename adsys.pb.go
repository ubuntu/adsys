...
var file_adsys_proto_rawDesc = []byte{
	...
	0x32, 0xb6, 0x02, 0x0a, 0x07, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x20, 0x0a, 0x03,
...
var file_adsys_proto_depIdxs = []int32{
	...
	5, // 5: service.DumpPoliciesDefinitions:input_type -> DumpPolicyDefinitionsRequest
	2, // 6: service.Cat:output_type -> StringResponse
	2, // 7: service.Version:output_type -> StringResponse
	0, // 8: service.Stop:output_type -> Empty
	0, // 9: service.UpdatePolicy:output_type -> Empty
	2, // 10: service.DumpPolicies:output_type -> StringResponse
	6, // 11: service.DumpPoliciesDefinitions:output_type -> DumpPolicyDefinitionsResponse

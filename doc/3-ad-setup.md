...
Those are the 2 files that must to be copied on your Active Directory server.

You can find the latest version of those files in a [dedicated directory of the upstream repository](https://github.com/XXXXXXX). Note though that not all the keys may be supported by our local `ADSys` installation. Only the templates generated by `adysctl` match the version of your client.
...
![Ubuntu GPOs in Active Directory](images/3-gpo_editor-tree.png)

![Ubuntu Settings details page](images/3-gpo_editor-details.png)

...
The `cat` command has already been described in [the previous chapter](./10.-The-adsys-daemon.md). You can display logs with debugging levels independent of daemon and clients debugging levels. Local printing will also be forwarded.

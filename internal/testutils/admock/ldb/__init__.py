...
##############################
# OU=RnD,OU=IT Dept,DC=example,DC=biz
...
# [b'[LDAP://cn={83A5BD5B-1D5D-472D-827F-DE0E6F714300},cn=policies,cn=system,DC=example,DC=biz;0][LDAP://cn={5EC4DF8F-FF4E-41DE-846B-52AA6FFAF242},cn=policies,cn=system,DC=example,DC=biz;0]'

# Message({'dn': Dn('OU=RnD,OU=IT Dept,DC=example,DC=biz'),
